...
if(mysql_query("INSERT INTO transactions (amount,type,method,details,date) VALUES ('$amount' , 'Deposit' , '$method' , '$details', '$date')"))
	{
			    ...
			    <div class="col-md-6" >
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                <button type="submit" name="btn-adddeposit" class="btn btn-default">
                                    <i class="fa fa-btn fa-plus"></i>Add Deposit 
                                </button>
                            </div>
                        </div>
