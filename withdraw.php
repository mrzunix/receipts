...
if(mysql_query("INSERT INTO transactions (amount,type,method,details,date) VALUES ('$amount' ,'Withdraw' , '$method' , '$details','$date')"))
	{
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                <button type="submit" name="btn-withdraw" class="btn btn-default">
                                    <i class="fa fa-btn fa-plus"></i>Withdraw
                                </button>
                            </div>
                        </div>
